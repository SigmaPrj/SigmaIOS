...
-(instancetype)init{
    ...
    if(self){
        ...
        NSDictionary* dictForScrollView1 = @{@"imageName":@"Course1"};
        NSDictionary* dictForScrollView2 = @{@"imageName":@"Course2"};
        NSDictionary* dictForScrollView3 = @{@"imageName":@"Course3"};
        NSDictionary* dictForScrollView4 = @{@"imageName":@"Course4"};
