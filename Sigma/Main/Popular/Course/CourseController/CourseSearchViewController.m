...
#import "CourseSearchInfo.h"

@interface CourseSearchViewController ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
-(void)initUI{
    ...
    //通过engine获得热门搜索词的数据
    self.dataArray = [[[CourseEngine shareInstances] searchWithData] mutableCopy];
...
-(UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CourseSearchInfo* courseSearchInfo = [[CourseSearchInfo alloc] init];
    courseSearchInfo = (CourseSearchInfo*)[self.dataArray objectAtIndex:indexPath.row];
    [button setTitle:courseSearchInfo.trendWord forState:UIControlStateNormal];
