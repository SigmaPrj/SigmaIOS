...
#define MAINPAGECELL_X 10*(SCREEN_WIDTH/SCREEN_HEIGHT)
...
#define MAINPAGENAMELABEL_WIDTH  SCREEN_WIDTH-MAINPAGENAMELABEL_X
#define MAINPAGENAMELABEL_HEIGHT 120*(SCREEN_WIDTH/SCREEN_HEIGHT)
